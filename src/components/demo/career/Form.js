  ...
  return (
    <div className="max-w-2xl mx-auto p-10 shadow-xl  mb-10">
      <div className="flex flex-col items-start space-y-4 p-6">
        ...
        <h2 className="text-4xl headingFont font-serif text-navy-900 text-[#14274A]">
        ...
        <div className="space-y-4">
          ...
          >
            <textarea
              ...
              placeholder="Message"
              rows={6}
              className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#B39B7D] paragraphFont focus:border-transparent transition duration-200 placeholder-gray-400 resize-y"
              required
            />
          </motion.div>
        </div>
