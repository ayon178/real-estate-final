import { contactHanfBanner } from '@/app/constant/images'
...
const HalfBanner = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.65)), url(${contactHanfBanner.src})`,
      }}
    >
      <h1 className="text-3xl headingFont md:text-5xl text-white">
        Contact us
      </h1>
